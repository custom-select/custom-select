...
mySelect.panel.addEventListener('custom-select:focus-outside-panel', function(e) {
  ...
  // Down
    ...
    console.log('Down');
    TweenLite.to(currPanel, 0.333, {scrollTo: (currOption.offsetTop + currOption.clientHeight - currPanel.clientHeight)});
  }
}, true);
mySelect.container.addEventListener('custom-select:open', function(e) {
  TweenLite.to(mySelect.panel, 0.666, {height: '10.7em', ease: Quart.easeOut});
});
