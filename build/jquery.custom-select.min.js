...
(function customSelectJQueryAdaptor(jQuery) {
  ...
  $.fn.customSelect = function builderwrap(opt) {
    for (var _len = arguments.length, nextArgs = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      nextArgs[_key - 1] = arguments[_key];
    }
    ...
    this.each(function builder() {
      ...
      if (!instance) {
        select.data('customSelect', (0, _index2.default)(this, opt)[0]);
        ret = this;

        // if instance already created call method
      } else if (typeof opt === 'string') {
        if (typeof instance[opt] === 'function') {
          ret = instance[opt].apply(instance, nextArgs);
          if (opt === 'destroy') {
          ...
          ret = opt === 'container' || opt === 'opener' || opt === 'select' || opt === 'panel' ? $(instance[opt]) : instance[opt];
        }
      }
    });
    return ret;
